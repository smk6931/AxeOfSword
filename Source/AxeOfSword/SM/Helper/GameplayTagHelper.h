...
namespace AOSGameplayTags
{
	...
	AXEOFSWORD_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Leviathan_SoundLoop)
	AXEOFSWORD_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Leviathan_SoundLoop_Throw)
