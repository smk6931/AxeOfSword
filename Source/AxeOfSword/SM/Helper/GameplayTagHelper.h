...
namespace AOSGameplayTags
{
	...
	AXEOFSWORD_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Leviathan_Sound)
	AXEOFSWORD_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Leviathan_Sound_TurnBack_End)
